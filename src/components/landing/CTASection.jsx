        ...
        <div className="mt-8 flex lg:mt-0 lg:shrink-0">
          <div className="inline-flex rounded-md shadow">
            <button
              ...
              className="bg-white inline-flex items-center justify-center rounded-md px-3 py-2 border border-transparent text-base font-medium text-purple-600 hover:bg-purple-50 transition-colors duration-200 cursor-pointer">
              Sign up for free
            </button>
          </div>
        </div>
